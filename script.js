...
// ===== HOME (with split camera fixed at top) =====
function renderHome() {
    var normalContent = '';
    ...
    if (S.cameraActiveInHome) {
        splitView = '<div id="splitViewContainer" style="position:fixed;top:0;left:0;right:0;bottom:0;z-index:2000;background:#000;display:flex;flex-direction:column;">'+
            '<div id="splitCameraContainer" style="flex:4; background:#000; position:relative;">'+
            ...
            '</div>'+
            '<div id="splitCartContainer" style="flex:6; background:#f5f7ff; padding:13px; border-top:2px solid #dde4ff; display:flex; flex-direction:column; overflow-y:auto;">'+
